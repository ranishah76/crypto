...
import { Header, Segment, Button, Table, Input } from 'semantic-ui-react'

export default class BiggestLosers extends Component {
 constructor(props) {
   super(props)
 }
 ...
 sortgainers = () => {
  ...
  let sorted = this.state.data.sort(function(a, b) {
     return  b["quotes"]["USD"][`${time}`] - a["quotes"]["USD"][`${time}`]
   })
   return sorted
 }
...
<Table.Body class="ui small table" class="ui black table">
