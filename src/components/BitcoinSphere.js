...
class BitCoinSpheres extends Component {
  ...
  createArray = () => {
   ...
   createBox = () => {
    let box =  (
      <a-box id="cube" depth="0.5" height="0.5" width="0.5" position={this.createPosition()} rotation={this.createRotation()} color={this.createColor()}>
